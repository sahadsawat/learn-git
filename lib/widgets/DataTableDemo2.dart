...
class DataTableDemoState extends State<DataTableDemo> {
  ...
  _deleteEmployee(Employee employee) {
    ...
    Services.deleteEmployee(employee.id as String).then((result) {
      if ('success' == result) {
        setState(() {
  ...
  _updateEmployee(Employee employee) {
    ...
    Services.updateEmployee(employee.id as String, _firstNameController.text,
